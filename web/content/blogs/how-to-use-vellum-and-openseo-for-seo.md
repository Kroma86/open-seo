...
## 3 Core Workflows for Agentic Search
...
> _"Look up competitor.com's organic footprint via OpenSEO. Filter out their branded terms, and show me the top 5 high-intent keywords with search volume over 500 and difficulty under 35 where we don't currently rank."_
...
> _"Take keyword #2 and generate an outline targeting that exact search intent. What specific questions are competitors failing to answer?"_
...
> _"Pull the live top 10 Google results for [target query] via OpenSEO. Analyze the top ranking pages: What structure are they using? What specific questions or buyer requirements do they completely ignore? Where is the consensus weak?"_
...
> _"Add these 6 keywords to our OpenSEO rank tracker. Flag any movement greater than 3 positions."_
...
- **Name the deliverable, not the steps:** Ask for what done looks like: _"Give me the top 3 high-volume search queries for this topic that have low competition"_, not a step-by-step tutorial.
